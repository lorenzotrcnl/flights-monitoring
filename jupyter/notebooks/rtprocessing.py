...
if __name__ == '__main__':
    ...
    # FLIGHTS PER ZONE PROCESSING
    fpzdf = df.withColumn("timest",to_timestamp("ts")) \
    ...
    fpzdf.writeStream \
      .format("mongodb") \
      .option("checkpointLocation", "/tmp/mongocheckpoint2/") \
      .option("forceDeleteTempCheckpointLocation", "true") \
      .option("spark.mongodb.connection.uri", "mongodb://mongodb:27017/") \
      .option("spark.mongodb.database", "flightsDB") \
      .option("spark.mongodb.collection", "fpzRT") \
      .outputMode("append") \
      .start()
